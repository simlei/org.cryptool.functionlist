...
if __name__ == "__main__":
    ...
    parser.add_argument("steps", nargs="?", choices=stepchoices, action="append", help=f"step name sequence (of: {stepchoices}). When omitted, the defaultSteps from the config.yaml file are run.", metavar="STEPS")
